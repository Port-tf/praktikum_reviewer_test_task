...
# А если в значении словаря создавать кортежи и в них хранить название валюты и
# константу, то условий ниже можно будет избавиться вообще, нужно только предусмотреть случай,
# если придет ключ которого нет в словаре, чтобы код не сломался.
